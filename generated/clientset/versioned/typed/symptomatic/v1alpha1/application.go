...
import (
	...
	scheme "github.com/symptomatichq/platform-controller/generated/clientset/versioned/scheme"
...
func newApplications(c *SymptomaticV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
